...
def monte_carlo_simulation(episodes, policy_player):
    wins = 0
    losses = 0
    draws = 0

    for _ in range(episodes):
        _, reward, _ = play(policy_player)
...
if __name__ == '__main__':
    ...
    # Use the target_policy_player or any other policy you have defined
    win_rate, loss_rate, draw_rate = monte_carlo_simulation(episodes, target_policy_player)
